/*
  ...
  - You are about to drop the column `headers` on the `Endpoint` table. All the data in the column will be lost.
...
INSERT INTO "new_Endpoint" ("authorization", "createdAt", "id", "institutionId", "method", "name", "status", "updatedAt", "url") SELECT "authorization", "createdAt", "id", "institutionId", "method", "name", "status", "updatedAt", "url" FROM "Endpoint";
DROP TABLE "Endpoint";
